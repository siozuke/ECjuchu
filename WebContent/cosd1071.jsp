...
<%
	...
	try {
		if (juchu.getJuchuD().equals(kokyaku.getTourokuD())) {
			//受注金額の編集
			sJuchuKingaku = nf.format(juchu.getKoujinKingaku());
			//消費税の編集
			sTax = nf.format((int) (juchu.getKoujinKingaku() * juchu.getTaxRate()));
			//合計金額の編集
			sTotal = nf.format(juchu.getKoujinKingaku() +
					(int) (juchu.getKoujinKingaku() * juchu.getTaxRate()));
		}else {
			//受注金額の編集
